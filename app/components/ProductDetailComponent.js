...
import { Text, View, StyleSheet, Image, ScrollView, TouchableOpacity, Picker, Alert, Platform } from 'react-native';
...
import { sampleSingleProductDetail, sampleColorOptions, sampleSizeOptions } from '../data/DummyData';
            ...
            <View style={styles.container}>
                ...
                <ScrollView onScroll={this.onScroll.bind(this)}>
                    ...
                    <View style={styles.contentWrap}>
                        <Text style={styles.pdtTitle}>{this.state.datasource[0].singlePdtDetail.pdt_name}</Text>
                        <Text style={styles.salePrice}>SALE {this.state.datasource[0].singlePdtDetail.sale_price}</Text>
                        <Text style={styles.regPrice}>Reg {this.state.datasource[0].singlePdtDetail.reg_price}</Text>
                        <View style={{ flex: 1, flexDirection: 'row', marginLeft: 10, marginVertical: 6, paddingBottom: 20 }}>
                            ...
                            />
                            <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#000' }}>({this.state.datasource[0].singlePdtDetail.star_count})</Text>
                        </View>
                        <View style={styles.offerStack}>
                            <Text style={{ fontSize: 20, textAlign: 'center', fontWeight: 'bold', color: '#000' }}>Offer Stack</Text>
                        </View>
                        <View style={styles.dropdownWrap}>
                            <Text style={{ fontSize: 18, marginLeft: 10, fontWeight: 'bold', color: '#000' }}>Size</Text>
                            <ModalDropdown
                        ...
                        <View style={styles.dropdownWrap}>
                            <Text style={{ fontSize: 18, marginLeft: 10, fontWeight: 'bold', color: '#000' }}>Color</Text>
                            <ModalDropdown
                        ...
                        <View style={styles.qtyWrap}>
                            ...
                            <View style={styles.qtyDropdown}>
                                <TouchableOpacity>
                                    <Icon name="minus" size={30} color='#000' onPress={this.decrementQty.bind(this)}
                                        style={this.state.qty == 1 ? styles.buttonInValid : styles.buttonValid} />
                                </TouchableOpacity>
                                <Text style={styles.qtyText}>{this.state.qty}</Text>
                                <TouchableOpacity>
                                    <Icon name="plus" size={30} color='#000' onPress={this.incrementQty.bind(this)} style={{ paddingRight: 10 }} />
                                </TouchableOpacity>
                            </View>
                        </View>
                        <View>
                            <View style={styles.tabWrap}>
                                ...
                                <Icons name="ios-arrow-forward" size={30} color='#000' style={styles.tabIcon} />
                            </View>
                            <View style={styles.tabWrap}>
                        ...
                        <View style={styles.shareWrap}>
                            <TouchableOpacity style={styles.shareInnerWrap}>
                                <Icon name="share" size={30} color='#000' style={{ marginRight: 8 }} />
                                <Text style={styles.shareTitle}>{'share'.toUpperCase()}</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={[styles.shareInnerWrap, { paddingHorizontal: 25 }]}>
                                <Icon name="gift" size={30} color='#000' style={{ marginRight: 8 }} />
                                <Text style={styles.shareTitle}>{'registry'.toUpperCase()}</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.shareInnerWrap}>
                                <Icon name="wunderlist" size={30} color='#000' style={{ marginRight: 8 }} />
                        ...
                        <View>
                            <Text style={{ fontSize: 20, textAlign: 'left', fontWeight: 'bold', color: '#000', marginBottom: 15, marginLeft: 10 }}>YOU MAY LIKE THESE</Text>
                ...
                <View style={styles.fixedWrap}>
                    ...
                    <TouchableOpacity style={{ position:'absolute',bottom:0,height:45,width:'100%' }} onPress={this.addToCart.bind(this)}>
                    </TouchableOpacity>
                </View>
            </View>
        );
